...
# Pasamos el texto a minusculas, para que las cuente de igual manera, sean mayusculas o minusuculas
texto.lower
...
c = Counter(texto).most_common(1)
print(f"el caracter mas repetiod y la cantidad de veces que aparece es : {c}")